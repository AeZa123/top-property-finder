                            ...
                            <div class="col-md-8">
                                <div class="row justify-content-between text-center">
                                    <div class="col-md-4">
                                        ...
                                        <img class="mb-2" width="30%" src="{{ asset('images/icon/2.png') }}"
                                            alt="">
                                        <br class="mb-2">
                                        <a class="mt-2 bg-info px-4 rounded-pill font-size-20">คอนโด</a>
                                    </div>
                                    <div class="col-md-4">
                                        {{-- <i class="fas fa-home fa-lg"></i> --}}
                                        <img class="mb-2" width="30%" src="{{ asset('images/icon/home_icon.png') }}"
                                            alt="">
                                        <br>

                                        <a class="mt-2 bg-info px-4 rounded-pill font-size-20">บ้าน</a>

                                    </div>
                                    <div class="col-md-4">
                                        {{-- <i class="fas fa-home fa-lg"></i> --}}
                                        <img class="mb-2" width="30%" src="{{ asset('images/icon/3.png') }}"
                                            alt="">
                                        <br>

                                        <a class="mt-2 bg-info px-4 rounded-pill font-size-20">ตึกแถว</a>
                            ...
                            <div class="row no-gutters">
                                <div class="col-md-4">
                                    <img width="185" height="197"
                                        src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQX814i1YAhcte3vjS-py2x1V86k9pUVSbZqIZSB8q7xg&s"
                                        alt="...">
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-5">
                                                <a href="">
                                                    <span class="card-text float-right bg-red px-3"
                                                        style="border-radius: 15px;">view</span>
                                                </a>
                                            </div>
                                        </div>
